...
import (
	...
	scheme "github.com/munnerz/k8s-api-pager-demo/pkg/client/clientset/internalversion/scheme"
...
type AlertInterface interface {
	Create(*pager.Alert) (*pager.Alert, error)
	Update(*pager.Alert) (*pager.Alert, error)
	UpdateStatus(*pager.Alert) (*pager.Alert, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*pager.Alert, error)
	List(opts v1.ListOptions) (*pager.AlertList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *pager.Alert, err error)
	AlertExpansion
}
...
func newAlerts(c *PagerClient, namespace string) *alerts {
	return &alerts{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *alerts) Get(name string, options v1.GetOptions) (result *pager.Alert, err error) {
	result = &pager.Alert{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("alerts").
...
func (c *alerts) List(opts v1.ListOptions) (result *pager.AlertList, err error) {
	result = &pager.AlertList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("alerts").
...
func (c *alerts) Create(alert *pager.Alert) (result *pager.Alert, err error) {
	result = &pager.Alert{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("alerts").
...
func (c *alerts) Update(alert *pager.Alert) (result *pager.Alert, err error) {
	result = &pager.Alert{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("alerts").
...
func (c *alerts) UpdateStatus(alert *pager.Alert) (result *pager.Alert, err error) {
	result = &pager.Alert{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("alerts").
...
func (c *alerts) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *pager.Alert, err error) {
	result = &pager.Alert{}
