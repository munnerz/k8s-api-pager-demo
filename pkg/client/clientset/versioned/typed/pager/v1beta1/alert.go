...
import (
	...
	scheme "github.com/munnerz/k8s-api-pager-demo/pkg/client/clientset/versioned/scheme"
...
type AlertInterface interface {
	Create(*v1beta1.Alert) (*v1beta1.Alert, error)
	Update(*v1beta1.Alert) (*v1beta1.Alert, error)
	UpdateStatus(*v1beta1.Alert) (*v1beta1.Alert, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.Alert, error)
	List(opts v1.ListOptions) (*v1beta1.AlertList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Alert, err error)
	AlertExpansion
}
...
func newAlerts(c *PagerV1beta1Client, namespace string) *alerts {
	return &alerts{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *alerts) Get(name string, options v1.GetOptions) (result *v1beta1.Alert, err error) {
	result = &v1beta1.Alert{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("alerts").
		Name(name).
...
func (c *alerts) List(opts v1.ListOptions) (result *v1beta1.AlertList, err error) {
	result = &v1beta1.AlertList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("alerts").
...
func (c *alerts) Create(alert *v1beta1.Alert) (result *v1beta1.Alert, err error) {
	result = &v1beta1.Alert{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("alerts").
...
func (c *alerts) Update(alert *v1beta1.Alert) (result *v1beta1.Alert, err error) {
	result = &v1beta1.Alert{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("alerts").
...
func (c *alerts) UpdateStatus(alert *v1beta1.Alert) (result *v1beta1.Alert, err error) {
	result = &v1beta1.Alert{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("alerts").
...
func (c *alerts) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Alert, err error) {
	result = &v1beta1.Alert{}
