...
import (
	internalversion "github.com/munnerz/k8s-api-pager-demo/pkg/client/clientset/internalversion"
	internalinterfaces "github.com/munnerz/k8s-api-pager-demo/pkg/client/informers/internalversion/internalinterfaces"
	pager "github.com/munnerz/k8s-api-pager-demo/pkg/client/informers/internalversion/pager"
...
func (f *sharedInformerFactory) Pager() pager.Interface {
	return pager.New(f, f.namespace, f.tweakListOptions)
}
