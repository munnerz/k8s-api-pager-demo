...
import (
	"github.com/munnerz/k8s-api-pager-demo/pkg/client/internalclientset/scheme"
...
// PagerClient is used to interact with features provided by the pager group.
...
func setConfigDefaults(config *rest.Config) error {
	g, err := scheme.Registry.Group("pager")
	if err != nil {
		return err
	}
